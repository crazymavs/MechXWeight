...
<section class="section">
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Old Solvent Yard report</h5>
					<div class="row mb-3">
						<div class="col-md-10">
							<div class="row">
							<div class="col-md-3">
					...
					<div class="row mb-3 pt-3">
						<div class="text-center">
							<button class="btn btn-primary" id="btnGetTankYardReport">Get Old Solvent Yard Report&nbsp;&nbsp;<i class="fa-duotone fa-solid fa-tank-water"></i></button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						...
						<div class="table-responsive" id="dvOldSolventYardReports">
							<table class="table table-striped mt-3 mb-3 pb-3" id="varianceReport">
								<thead>
								<tr>
									<th colspan="13"><h5>Old Solvent Yard Report from <strong><span id="osyFrom"></span></strong> to <strong><span id="osyTo"></span></strong></h5></th>
								</tr>
								<tr>
									<th>Sl No</th>
									...
									<th>Output Towards Deco/General (kg)<br>F</th>
									<th>Output Towards Wood Finish 1st floor (kg)<br>G</th>
									<th>Output Towards Old Resin (kg)<br>H</th>
									
									<th>Deviation b/w C & F+G+H (kg)<br>C - F+G+H</th>

								</tr>
								</thead>
								<tbody id="oldSolventYardBody">
								<!-- Data rows -->
  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="referenceModalLabel">Report Reference for Old Solvent Yard</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-center">
		<img src="<?= $asset_base ?>assets/img/osy.jpg" alt="New Solvent Yard">
      </div>
...
<script>
	...
	//     $("#tblSolventYardReport").excelexportjs({
	//         containerid:"tblSolventYardReport",
	//         datatype:'table'
	//     });
	// }
	...
	document.getElementById('btnExportSolventYardReportXL').addEventListener('click', function() {
		...
		let workbook = XLSX.utils.table_to_book(table, {
			sheet: "Old Solvent Yard Report"
		});
		XLSX.writeFile(workbook, 'Old Solvent Yard Report.xlsx');
